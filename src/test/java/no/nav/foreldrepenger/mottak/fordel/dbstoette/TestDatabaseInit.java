package no.nav.foreldrepenger.mottak.fordel.dbstoette;
...
public final class TestDatabaseInit {
    ...
    private static final String DB_SCRIPT_LOCATION = "/db/postgres/defaultDS"; // Endret fra /defaultDS under migreringer-modul
    ...
    private static String fileScriptLocation() {
        // Støtter både gammel modulstruktur (migreringer/...) og ny monorepo-struktur (src/main/resources/...)
        var candidateRelativePaths = new String[] {
            "migreringer/src/main/resources" + DB_SCRIPT_LOCATION, // gammel
            "src/main/resources" + DB_SCRIPT_LOCATION              // ny
        };
        for (var relativePath : candidateRelativePaths) {
        ...
        throw new IllegalArgumentException("Klarte ikke finne migreringsskripter for noen av kandidatstiene (" + String.join(", ", candidateRelativePaths) + ")");
    }
