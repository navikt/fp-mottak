...
class ManuellJournalføringMapperTest {
    ...
    void mapHendelseTypeJF() {
        assertThat(ManuellJournalføringMapper.mapHendelseTypeJF(SakInfoV2Dto.FamilieHendelseTypeDto.FØDSEL)).isEqualTo(
                FamilihendelseTypeJFDto.FØDSEL);
    }

    @Test
    void mapYtelseTypeFraDto() {
        assertThat(ManuellJournalføringMapper.mapYtelseTypeFraDto(
                YtelseTypeDto.ENGANGSTØNAD)).isEqualTo(FagsakYtelseTypeDto.ENGANGSTØNAD);
