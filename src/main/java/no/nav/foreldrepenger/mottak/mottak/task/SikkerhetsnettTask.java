...
import no.nav.foreldrepenger.mottak.mottak.task.sikkerhetsnett.SikkerhetsnettJournalpost;
import no.nav.foreldrepenger.mottak.mottak.task.sikkerhetsnett.SikkerhetsnettKlient;
...
public class SikkerhetsnettTask implements ProsessTaskHandler {
    ...
    public void doTask(ProsessTaskData prosessTaskData) {
        ...
        LOG.info("FPMOTTAK SIKKERHETSNETT fant {} journalposter uten oppgave: {}", åpneJournalposterUtenOppgave.size(), åpneJournalposterTekst);
