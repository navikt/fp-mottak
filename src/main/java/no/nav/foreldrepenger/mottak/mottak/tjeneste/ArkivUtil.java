...
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.BehandlingTema.ENGANGSSTØNAD_ADOPSJON;
...
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.BehandlingTema.SVANGERSKAPSPENGER;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.BehandlingTema.UDEFINERT;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_FLEKSIBELT_UTTAK_FORELDREPENGER;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_FORELDREPENGER_ENDRING_SØKNAD;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_SØKNAD_ENGANGSSTØNAD_ADOPSJON;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_SØKNAD_ENGANGSSTØNAD_FØDSEL;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_SØKNAD_FORELDREPENGER_ADOPSJON;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_SØKNAD_FORELDREPENGER_FØDSEL;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.ETTERSENDT_SØKNAD_SVANGERSKAPSPENGER_SELVSTENDIG;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.FLEKSIBELT_UTTAK_FORELDREPENGER;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.FORELDREPENGER_ENDRING_SØKNAD;
import static no.nav.foreldrepenger.mottak.fordel.kodeverdi.DokumentTypeId.SØKNAD_ENGANGSSTØNAD_ADOPSJON;
