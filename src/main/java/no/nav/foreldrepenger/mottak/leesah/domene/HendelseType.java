...
import static no.nav.foreldrepenger.mottak.leesah.domene.HendelseEndringType.ANNULLERT;
import static no.nav.foreldrepenger.mottak.leesah.domene.HendelseEndringType.KORRIGERT;
import static no.nav.foreldrepenger.mottak.leesah.domene.HendelseEndringType.OPPHOERT;
...
import no.nav.foreldrepenger.mottak.fordel.kodeverdi.Kodeverdi;
